...
class User(AbstractUser):
    ...
    postal_code = models.CharField(max_length=10, null=True, blank=True, verbose_name='کد پستی شخصیت حقیقی')
    ...
    official_postal_code = models.CharField(max_length=10, null=True, blank=True, verbose_name='کد پستی شخصیت حقوقی')
